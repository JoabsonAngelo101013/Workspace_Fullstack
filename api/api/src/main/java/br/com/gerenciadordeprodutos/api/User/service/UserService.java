package br.com.gerenciadordeprodutos.api.User.service;

import br.com.gerenciadordeprodutos.api.Security.authentication.JwtTokenService;
import br.com.gerenciadordeprodutos.api.Security.config.SecurityConfiguration;
...
public class UserService {
    ...
    public RecoveryJwtTokenDto authenticateUser(LoginUserRequest loginUserRequest) {
    ...
    public void createUser(CreateUserRequest createUserRequest) {
        ...
        User newUser = User.builder()
                ...
                .password(securityConfiguration.passwordEncoder().encode(createUserRequest.password()))
                // Atribui ao usuário uma permissão específica
                .roles(List.of(Role.builder().name(createUserRequest.role()).build()))
                .build();
